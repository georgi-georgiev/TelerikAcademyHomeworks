...
namespace _01.Include
{
    ...
    public partial class TelerikAcademyEntities : DbContext
    {
        ...
        [EdmFunction("TelerikAcademyEntities", "fn_ListEmployees")]
        public virtual IQueryable<fn_ListEmployees_Result> fn_ListEmployees(string format)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_ListEmployees_Result>("[TelerikAcademyEntities].[fn_ListEmployees](@format)", formatParameter);
        }
